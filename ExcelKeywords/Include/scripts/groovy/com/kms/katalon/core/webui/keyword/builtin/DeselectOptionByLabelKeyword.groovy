...
public class DeselectOptionByLabelKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        deselectOptionByLabel(to,labelText,isRegex,flowControl)
    }

    @CompileStatic
    public void deselectOptionByLabel(TestObject to, String labelText, boolean isRegex,
        ...
        }, flowControl, true, (to != null && labelText != null) ? MessageFormat.format(StringConstants.KW_MSG_CANNOT_DESEL_OPT_BY_LBL_OF_OBJ, labelText, to.getObjectId(), regularExpressionLog) : MessageFormat.format(StringConstants.KW_MSG_CANNOT_DESEL_OPT_BY_LBL, regularExpressionLog))
    }
}
