...
public class GetElementLeftPosition extends WebUIAbstractKeyword {
    ...
    public Object execute(Object... params) {
        ...
        return getElementLeftPosition(to, flowControl)
    }

    @CompileStatic
    public int getElementLeftPosition(TestObject to, FailureHandling flowControl) throws StepFailedException {
        ...
        }, flowControl, true, (to != null) ? MessageFormat.format(CoreWebuiMessageConstants.KW_MSG_CANNOT_GET_ELEMENT_LEFT_POSITION, to.getObjectId())
        : CoreWebuiMessageConstants.KW_MSG_CANNOT_GET_ELEMENT_LEFT_POSITION)
    }
}
