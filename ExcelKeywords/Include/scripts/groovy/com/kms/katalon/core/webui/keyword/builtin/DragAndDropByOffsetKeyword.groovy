...
@Action(value = "dragAndDropByOffset")
public class DragAndDropByOffsetKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        int xOffset = (int) params[1]
        int yOffset = (int) params[2]
        ...
        dragAndDropByOffset(sourceObject,xOffset,yOffset,flowControl)
    }

    @CompileStatic
    public void dragAndDropByOffset(TestObject sourceObject, int xOffset, int yOffset,
