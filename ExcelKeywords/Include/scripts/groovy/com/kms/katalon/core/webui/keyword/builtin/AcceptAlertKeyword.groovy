...
@Action(value = "acceptAlert")
public class AcceptAlertKeyword extends WebUIAbstractKeyword {
	...
	public Object execute(Object ...params) {
		...
		acceptAlert(flowControl)
	}

	@CompileStatic
	public void acceptAlert(FailureHandling flowControl) throws StepFailedException {
