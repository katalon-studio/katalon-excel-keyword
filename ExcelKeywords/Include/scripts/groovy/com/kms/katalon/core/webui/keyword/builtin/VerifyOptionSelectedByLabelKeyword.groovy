...
@Action(value = "verifyOptionSelectedByLabel")
public class VerifyOptionSelectedByLabelKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return verifyOptionSelectedByLabel(to,label,isRegex,timeOut,flowControl)
    }

    @CompileStatic
    public boolean verifyOptionSelectedByLabel(TestObject to, String label, boolean isRegex, int timeOut,
        ...
        return WebUIKeywordMain.runKeyword({
            ...
            try {
                ...
                int numSelectedOptions = WebUiCommonHelper.getNumberOfSelectedOptionByLabel(select, label, isRegex, to.getObjectId())
                ...
                if (numLabelOptions == 0) {
                    ...
                    WebUIKeywordMain.stepFailed(MessageFormat.format(StringConstants.KW_MSG_ONLY_X_IN_Y_OPTS_W_LBL_Z_SELECTED_IN_OBJ, numSelectedOptions, numLabelOptions, label, to.getObjectId(), regularExpressionLog), flowControl, null, true)
                } else {
        ...
        MessageFormat.format(StringConstants.KW_MSG_CANNOT_VERIFY_OPT_IS_SELECTED_BY_LBL_X_IN_OBJ_Y, label, to.getObjectId(), regularExpressionLog) : MessageFormat.format(StringConstants.KW_MSG_CANNOT_VERIFY_OPT_IS_SELECTED_BY_LBL_X, regularExpressionLog))
    }
}
