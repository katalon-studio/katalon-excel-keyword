...
public class DeselectOptionByValueKeyword extends WebUIAbstractKeyword {
    ...
    throws StepFailedException {
        ...
        }, flowControl, true, (to != null && value != null) ? MessageFormat.format(StringConstants.KW_MSG_CANNOT_DESELECT_OPT_BY_VAL_OF_OBJ, value, to.getObjectId(), regularExpressionLog) : MessageFormat.format(StringConstants.KW_MSG_CANNOT_DESELECT_OPT_BY_VAL, regularExpressionLog))
    }
}
