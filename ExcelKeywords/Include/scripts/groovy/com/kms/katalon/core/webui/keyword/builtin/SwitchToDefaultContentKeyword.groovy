...
@Action(value = "switchToDefaultContent")
public class SwitchToDefaultContentKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        switchToDefaultContent(flowControl)
    }

    @CompileStatic
    public void switchToDefaultContent(FailureHandling flowControl) throws StepFailedException {
