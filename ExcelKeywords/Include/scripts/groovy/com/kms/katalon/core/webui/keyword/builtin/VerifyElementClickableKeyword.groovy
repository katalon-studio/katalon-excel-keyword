...
@Action(value = "verifyElementClickable")
public class VerifyElementClickableKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return verifyElementClickable(to,flowControl)
    }

    @CompileStatic
    public boolean verifyElementClickable(TestObject to, FailureHandling flowControl) throws StepFailedException {
