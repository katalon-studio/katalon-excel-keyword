...
@Action(value = "getNumberOfTotalOption")
public class GetNumberOfTotalOptionKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return getNumberOfTotalOption(to,flowControl)
    }

    @CompileStatic
    public int getNumberOfTotalOption(TestObject to, FailureHandling flowControl) throws StepFailedException {
