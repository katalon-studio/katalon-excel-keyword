...
@Action(value = "getViewportWidth")
public class GetViewportWidthKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return getViewportWidth(flowControl)
    }

    @CompileStatic
    public int getViewportWidth(FailureHandling flowControl) throws StepFailedException {
