...
@Action(value = "check")
public class CheckKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        check(to,flowControl)
    }

    @CompileStatic
    public void check(TestObject to, FailureHandling flowControl) throws StepFailedException {
        WebUIKeywordMain.runKeyword({
            ...
            try {
                ...
                logger.logDebug(MessageFormat.format(StringConstants.KW_LOG_INFO_CHECKING_ON_OBJ, to.getObjectId()))
