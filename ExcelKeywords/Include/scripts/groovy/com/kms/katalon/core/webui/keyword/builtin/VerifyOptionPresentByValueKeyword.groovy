...
@Action(value = "verifyOptionPresentByValue")
public class VerifyOptionPresentByValueKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return verifyOptionPresentByValue(to,value,isRegex,timeOut,flowControl)
    }

    @CompileStatic
    public boolean verifyOptionPresentByValue(TestObject to, String value, boolean isRegex, int timeOut,
        ...
        MessageFormat.format(StringConstants.KW_MSG_CANNOT_VERIFY_OPT_IS_PRESENT_BY_VAL_X_IN_OBJ_Y, value, to.getObjectId(), regularExpressionLog) : MessageFormat.format(StringConstants.KW_MSG_CANNOT_VERIFY_OPT_IS_PRESENT_BY_VAL_X, regularExpressionLog))
    }
}
