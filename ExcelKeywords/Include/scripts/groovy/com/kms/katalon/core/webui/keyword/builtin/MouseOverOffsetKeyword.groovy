...
@Action(value = "mouseOverOffset")
public class MouseOverOffsetKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        mouseOverOffset(to, offsetX, offsetY, flowControl)
    }

    @CompileStatic
    public void mouseOverOffset(TestObject to, int offsetX, int offsetY, FailureHandling flowControl) throws StepFailedException {
        ...
        }, flowControl, true, (to != null) ? MessageFormat.format(CoreWebuiMessageConstants.KW_MSG_CANNOT_MOVE_MOUSE_OVER_OBJ_X_OFFSET_Y_Z, to.getObjectId(), offsetX, offsetY)
        : CoreWebuiMessageConstants.KW_MSG_CANNOT_MOVE_MOUSE_OVER_OBJ_OFFSET)
    }
}
