...
@Action(value = "switchToWindowUrl")
public class SwitchToWindowUrlKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        switchToWindowUrl(url,flowControl)
    }
    ...
    public void switchToWindowUrl(String url, FailureHandling flowControl) throws StepFailedException {
        ...
        }, flowControl, true, (url != null) ? MessageFormat.format(StringConstants.KW_MSG_CANNOT_SWITCH_TO_WINDOW_W_URL_X, url) : StringConstants.KW_MSG_CANNOT_SWITCH_TO_WINDOW_URL)
    }
}
