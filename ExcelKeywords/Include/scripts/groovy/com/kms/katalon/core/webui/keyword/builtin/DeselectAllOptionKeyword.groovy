...
@Action(value = "deselectAllOption")
public class DeselectAllOptionKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        deselectAllOption(to,flowControl)
    }

    @CompileStatic
    public void deselectAllOption(TestObject to, FailureHandling flowControl) throws StepFailedException {
