...
@Action(value = "focus")
public class FocusKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        focus(to,flowControl)
    }

    @CompileStatic
    public void focus(TestObject to, FailureHandling flowControl) throws StepFailedException {
        WebUIKeywordMain.runKeyword({
            ...
            try {
                ...
                logger.logDebug(MessageFormat.format(StringConstants.KW_LOG_INFO_FOCUSING_ON_OBJ, to.getObjectId()))
