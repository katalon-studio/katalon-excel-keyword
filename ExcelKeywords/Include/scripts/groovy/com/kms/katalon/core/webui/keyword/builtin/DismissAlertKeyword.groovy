...
@Action(value = "dismissAlert")
public class DismissAlertKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        dismissAlert(flowControl)
    }

    @CompileStatic
    public void dismissAlert(FailureHandling flowControl) throws StepFailedException {
        WebUIKeywordMain.runKeyword({
            Alert alert = DriverFactory.getAlert()
            if (alert != null) {
                logger.logDebug(StringConstants.KW_LOG_INFO_DISMISSING_ALERT)
                alert.dismiss()
