...
@Action(value = "verifyElementNotClickable")
public class VerifyElementNotClickableKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return verifyElementNotClickable(to,flowControl)
    }

    @CompileStatic
    public boolean verifyElementNotClickable(TestObject to, FailureHandling flowControl) throws StepFailedException {
