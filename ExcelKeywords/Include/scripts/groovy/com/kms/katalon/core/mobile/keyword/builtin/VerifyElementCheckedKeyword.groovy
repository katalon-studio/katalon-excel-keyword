...
@Action(value = "verifyElementChecked")
public class VerifyElementCheckedKeyword extends MobileAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return verifyElementChecked(to, timeout, flowControl)
    }
