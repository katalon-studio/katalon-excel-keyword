...
@Action(value = "verifyAlertPresent")
public class VerifyAlertPresentKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return verifyAlertPresent(timeOut,flowControl)
    }

    @CompileStatic
    public boolean verifyAlertPresent(int timeOut, FailureHandling flowControl) throws StepFailedException {
