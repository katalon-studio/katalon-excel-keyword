...
@Action(value = "getPageWidth")
public class GetPageWidthKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return getPageWidth(flowControl)
    }

    @CompileStatic
    public int getPageWidth(FailureHandling flowControl) {
