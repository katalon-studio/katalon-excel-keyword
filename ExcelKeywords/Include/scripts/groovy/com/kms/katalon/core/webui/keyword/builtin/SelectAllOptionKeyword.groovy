...
@Action(value = "selectAllOption")
public class SelectAllOptionKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        selectAllOption(to,flowControl)
    }

    @CompileStatic
    public void selectAllOption(TestObject to, FailureHandling flowControl) throws StepFailedException {
