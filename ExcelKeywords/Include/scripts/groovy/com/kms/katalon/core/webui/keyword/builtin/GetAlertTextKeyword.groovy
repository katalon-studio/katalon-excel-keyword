...
@Action(value = "getAlertText")
public class GetAlertTextKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return getAlertText(flowControl)
    }

    @CompileStatic
    public String getAlertText(FailureHandling flowControl) throws StepFailedException {
