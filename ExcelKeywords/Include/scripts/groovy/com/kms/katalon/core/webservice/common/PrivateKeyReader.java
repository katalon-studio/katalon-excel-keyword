 ...
 * 
 * <p/>
 * It can read PEM file contents with PKCS#8 or PKCS#1 encodings. It doesn't support
 * encrypted PEM file content.
 * 
 ...
 * @see https://github.com/awslabs/aws-iot-fuse/blob/master/src/main/java/com/amazonaws/services/iot/client/fuse/PrivateKeyReader.java
 */
public class PrivateKeyReader {
     ...
     *
     * @param keyFileContent private key file content
     * @return Private key
     * @throws IOException
     */
    public static PrivateKey getPrivateKey(String keyFileContent) throws IOException, GeneralSecurityException {
        try (InputStream stream = new ByteArrayInputStream(keyFileContent.getBytes());) {
            return getPrivateKey(stream);
        }
    }
