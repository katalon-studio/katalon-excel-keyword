...
public class VerifyOptionPresentByLabelKeyword extends WebUIAbstractKeyword {
    ...
    public boolean verifyOptionPresentByLabel(TestObject to, String label, boolean isRegex, int timeOut,
        ...
        return WebUIKeywordMain.runKeyword({
            ...
            return false
        }, flowControl, true, (to != null && label != null) ? MessageFormat.format(StringConstants.KW_MSG_CANNOT_VERIFY_OPT_IS_PRESENT_BY_LBL_X_IN_OBJ_Y, label, to.getObjectId(), regularExpressionLog) : MessageFormat.format(StringConstants.KW_MSG_CANNOT_VERIFY_OPT_IS_PRESENT_BY_LBL_X, regularExpressionLog))
    }
}
