...
public class VerifyElementNotVisibleKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return verifyElementNotVisible(to,flowControl)
    }

    @CompileStatic
    public boolean verifyElementNotVisible(TestObject to, FailureHandling flowControl) throws StepFailedException {
