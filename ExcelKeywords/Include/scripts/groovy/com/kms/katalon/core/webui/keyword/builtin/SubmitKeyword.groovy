...
@Action(value = "submit")
public class SubmitKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        submit(to,flowControl)
    }

    @CompileStatic
    public void submit(TestObject to, FailureHandling flowControl) throws StepFailedException {
        WebUIKeywordMain.runKeyword({
            ...
            try {
                ...
                logger.logDebug(MessageFormat.format(StringConstants.KW_LOG_INFO_SUBMITTING_ON_FORM_CONTAINING_OBJ, to.getObjectId()))
                webElement.submit()
