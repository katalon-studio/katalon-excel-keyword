...
@Action(value = "getViewportLeftPosition")
public class GetViewportLeftPositionKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return getViewportLeftPosition(flowControl)
    }

    @CompileStatic
    public int getViewportLeftPosition(FailureHandling flowControl) {
