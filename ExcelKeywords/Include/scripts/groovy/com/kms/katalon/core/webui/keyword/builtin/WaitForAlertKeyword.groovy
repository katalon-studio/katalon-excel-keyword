...
@Action(value = "waitForAlert")
public class WaitForAlertKeyword extends WebUIAbstractKeyword {
	...
	public Object execute(Object ...params) {
		...
		return waitForAlert(timeOut,flowControl)
	}

	@CompileStatic
	public boolean waitForAlert(int timeOut, FailureHandling flowControl) throws StepFailedException {
