...
@Action(value = "getPageHeight")
public class GetPageHeightKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return getPageHeight(flowControl)
    }

    @CompileStatic
    public int getPageHeight(FailureHandling flowControl) {
