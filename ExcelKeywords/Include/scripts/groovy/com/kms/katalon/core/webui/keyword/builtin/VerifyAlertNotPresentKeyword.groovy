...
@Action(value = "verifyAlertNotPresent")
public class VerifyAlertNotPresentKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        int timeOut = (int) params[0]
        FailureHandling flowControl = (FailureHandling)(params.length > 1 && params[1] instanceof FailureHandling ? params[1] : RunConfiguration.getDefaultFailureHandling())
        return verifyAlertNotPresent(timeOut,flowControl)
    }

    @CompileStatic
    public boolean verifyAlertNotPresent(int timeOut, FailureHandling flowControl) throws StepFailedException {
