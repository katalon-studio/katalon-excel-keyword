...
public class DoubleClickKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        doubleClick(to,flowControl)
    }

    @CompileStatic
    public void doubleClick(TestObject to, FailureHandling flowControl) throws StepFailedException {
        WebUIKeywordMain.runKeyword({
            ...
            try {
                ...
                logger.logDebug(MessageFormat.format(StringConstants.KW_LOG_INFO_DOUBLE_CLICK_ON_OBJ, to.getObjectId()))
